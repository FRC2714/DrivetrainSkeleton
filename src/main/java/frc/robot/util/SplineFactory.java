...
public class SplineFactory {
    ...
    private ArrayList<MotionProfile> controlPath;
    ...
    public SplineFactory(ArrayList<MotionProfile> controlPath, double period, 
                        double x1, double x2, double x3, double x4,
                        double y1, double y2, double y3, double y4, 
                        double acceleration, double maxVelocity, double startVelocity,
    ...
    public void generate() {
        ...
        for (int i = 0; i < xValues.size() - 1; i++) {
            ...
            controlPath.add(new MotionProfile(angle, velocity, xValues.get(i), yValues.get(i)));
